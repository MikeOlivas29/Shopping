...
namespace Shopping.Data
{
    public class SeedDb
    {
        ...
        public async Task SeedAsync()
        {
            ...
            await CheckUserAsync("2020", "Miguel", "Olivas", "mike@yopmail.com", "656 123 4567", "Av. Tecnologico", "miguel.jpg", UserType.Admin);
            await CheckUserAsync("3030", "Angel", "Modesto", "Modesto@yopmail.com", "656 324 4567", "Calle Campo Real", "modesto.jpg", UserType.Admin);
            await CheckUserAsync("4040", "Jacob", "Alanis", "jacob@yopmail.com", "656 654 9876", "Calle Zaragoza", "jacob.jpg", UserType.User);
        ...
        private async Task CheckProductsAsync()
        {
            if (!_context.Products.Any())
            {
                ...
                await AddProductAsync("AirPods", 1300000M, 12F, new List<string>() { "Tecnología", "Apple" }, new List<string>() { "airpods.png", "airpods2.png" });
                ...
                await AddProductAsync("iPhone 14 Pro Max", 5200000M, 6F, new List<string>() { "Tecnología", "Apple" }, new List<string>() { "iphone14_promax_black.png", "iphone14_promax_deeppurple.png", "iphone14_promax_golden.png", "iphone14_promax_silver.png" });
                ...
                await AddProductAsync("Nvidia RTX 3070 ti GIGABYTE", 980000M, 12F, new List<string>() { "Gamer", "Tecnología" }, new List<string>() { "rtx 3070 GIGABYTE.jpg" });
                await AddProductAsync("Mouse Gamer", 132000M, 12F, new List<string>() { "Gamer", "Tecnología" }, new List<string>() { "mouse.png" });
